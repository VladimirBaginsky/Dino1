...
imgCloud = imgSprites.subsurface(164,2,96,32)
...
while play:
    ...
    screen.blit(imgCloud, (150, 50))
    imgCloud_1 = pygame.transform.scale(imgCloud,(30,20))
    screen.blit(imgCloud_1, (330, 30))
    screen.blit(imgCloud, (540, 20))
